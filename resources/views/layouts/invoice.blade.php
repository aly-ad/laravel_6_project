...
<html>
<head>
	<title>Aly Laravel Software</title>
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="{{ url('/') }}"><h2>Aly Laravel Software</h2><!--<img src="{{ url('img/colorlogo33.jpg') }}" alt="" style="width: 235px;">--></a>
			...
			<div class="row footer_inner">
				<div class="col-lg-4 col-sm-6">
					<aside class="f_widget ab_widget">
						...
						<p>Aly Laravel Software for issue programs.</p>
						<p>
				&copy; {{date('Y')}} All rights reserved | Aly</p>
					</aside>
				</div>
				<div class="col-lg-4 col-sm-6">
